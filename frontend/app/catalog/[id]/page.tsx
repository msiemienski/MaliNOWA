      ...
      <div className="mt-6 grid gap-8 md:grid-cols-[1.2fr_1fr]">
        ...
        <aside className="rounded-xl border border-rose-200 bg-white p-6 shadow-sm">
          <div className="flex items-start justify-between gap-3">
            <h1 className="text-2xl font-bold text-rose-900">{clothing.name}</h1>
          ...
          <p className="mt-4 text-sm leading-6 text-rose-800">{clothing.description}</p>
          ...
          <div className="mt-6 space-y-2 border-t border-rose-100 pt-4">
            ...
            <p className="text-sm text-rose-700">Dostępna ilość: {clothing.stock}</p>
            <p className="text-sm text-rose-700">ID produktu: {clothing.id}</p>
          </div>
        </aside>
      </div>
    </section>
